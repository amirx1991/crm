...
const layouts = [
    {
        ...
        label: 'قابل جمع شدن',
        src: '/static/img/thumbs/layouts/classic.jpg',
        srcDark: '/static/img/thumbs/layouts/classic-dark.jpg',
        svg: <CollapsibleSideSvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_STACKED_SIDE,
        label: 'چیده شده',
        src: '/static/img/thumbs/layouts/modern.jpg',
        srcDark: '/static/img/thumbs/layouts/modern-dark.jpg',
        svg: <StackedSideSvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_TOP_BAR_CLASSIC,
        label: 'نوار بالایی',
        src: '/static/img/thumbs/layouts/stackedSide.jpg',
        srcDark: '/static/img/thumbs/layouts/stackedSide-dark.jpg',
        svg: <TopBarClassicSvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_FRAMELESS_SIDE,
        label: 'بی قاب',
        src: '/static/img/thumbs/layouts/simple.jpg',
        srcDark: '/static/img/thumbs/layouts/simple-dark.jpg',
        svg: <FrameLessSideSvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_CONTENT_OVERLAY,
        label: 'روی هم قرار دادن',
        src: '/static/img/thumbs/layouts/decked.jpg',
        srcDark: '/static/img/thumbs/layouts/decked-dark.jpg',
        svg: <ContentOverlaySvg height={'100%'} width={'100%'} />,
    },
    {
        value: LAYOUT_BLANK,
        label: 'خالی',
        src: '/static/img/thumbs/layouts/blank.jpg',
        srcDark: '/static/img/thumbs/layouts/blank-dark.jpg',
