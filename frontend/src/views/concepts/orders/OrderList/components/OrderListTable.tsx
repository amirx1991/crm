...
> = {
    ...
    2: { label: 'ناموفق', bgClass: 'bg-error-subtle', textClass: 'text-error' },
}
...
const ActionColumn = ({ row }: { row: Order }) => {
    ...
    return (
        <div className="flex justify-end text-lg gap-1">
            <Tooltip wrapperClass="flex" title="مشاهده">
                <span className={`cursor-pointer p-2`} onClick={onView}>
                    <TbEye />
                </span>
            </Tooltip>
            <Tooltip wrapperClass="flex" title="حذف">
                <span
    ...
    switch (paymentMehod) {
        case 'visa':
            return (
                <img
                    className={className}
                    src="/static/img/others/img-8.png"
                    alt={paymentMehod}
                />
            )
        case 'master':
            return (
                <img
                    className={className}
                    src="/static/img/others/img-9.png"
                    alt={paymentMehod}
                />
            )
        case 'paypal':
            return (
                <img
                    className={className}
                    src="/static/img/others/img-10.png"
                    alt={paymentMehod}
                />
            )
        default:
