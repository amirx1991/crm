...
const mapMeta: Record<string, { img: string }> = {
    us: { img: '/static/img/countries/US.png' },
    br: { img: '/static/img/countries/BR.png' },
    in: { img: '/static/img/countries/IN.png' },
    uk: { img: '/static/img/countries/UK.png' },
    tr: { img: '/static/img/countries/TR.png' },
    id: { img: '/static/img/countries/ID.png' },
}
