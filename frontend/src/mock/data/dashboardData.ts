        ...
        totalProfit: {
            thisWeek: {
                ...
                chartData: {
                    ...
                    date: ['دوشنبه', 'سه‌شنبه', 'چهارشنبه', 'پنج‌شنبه', 'جمعه', 'شنبه', 'یک‌شنبه'],
                },
            },
            thisMonth: {
                value: 82373.21,
                growShrink: 3.4,
                comparePeriod: 'از ماه گذشته',
                chartData: {
                    series: [
                        {
                            name: 'فروش',
        ...
        totalOrder: {
            thisWeek: {
                ...
                chartData: {
                    ...
                    date: ['دوشنبه', 'سه‌شنبه', 'چهارشنبه', 'پنج‌شنبه', 'جمعه', 'شنبه', 'یکشنبه'],
                },                
            },
            thisMonth: {
                value: 7234,
        ...
        totalImpression: {
            thisWeek: {
                ...
                chartData: {
                    ...
                    date: ['دوشنبه', 'سه‌شنبه', 'چهارشنبه', 'پنجشنبه', 'جمعه', 'شنبه', 'یکشنبه'],
                },
            },
            thisMonth: {
                value: 3123734,
    ...
    topProduct: [
        {
            ...
            img: '/static/img/products/product-7.jpg',
            sales: 1249,
            growShrink: 15.2,
        },
        {
            ...
            img: '/static/img/products/product-3.jpg',
            sales: 1145,
            growShrink: 13.9,
        },
        {
            ...
            img: '/static/img/products/product-9.jpg',
            sales: 1073,
            growShrink: 9.5,
        },
        {
            ...
            img: '/static/img/products/product-10.jpg',
            sales: 1022,
            growShrink: 2.3,
        },
        {
            ...
            img: '/static/img/products/product-12.jpg',
            sales: 992,
            growShrink: -0.7,
        },
        {
            ...
            img: '/static/img/products/product-6.jpg',
            sales: 1201,
            growShrink: -1.1,
        },
    ],
...
export const projectData = {
    ...
    recentActivity: [
        ...
        },
        {
            ...
            userImg: '/static/img/avatars/thumb-3.jpg',
            comment: `خوب، جاوا ممکن است مثال خوبی از این باشد که یک زبان برنامه نویسی باید چگونه باشد. اما برنامه های جاوا نمونه های خوبی از این هستند که برنامه ها نباید شبیه باشند.`,
        },
        {
        ...
        },
        {
            ...
            comment: `<strong>@Carolyn</strong> یکی از دلایل اصلی سقوط امپراتوری روم این بود که نداشتن صفر - آنها هیچ راهی برای پایان موفقیت آمیز برنامه های C خود نداشتند. `,
        },
        {
            type: 'ASSIGN-TICKET',
            dateTime: 1646554397,
            ...
            channels: [
                {
                    id: 'google',
                    name: 'Google',
                    img: '/static/img/others/google.png',
                    total: 31731,
                    percentage: 40,
                },
                {
                    id: 'instagram',
                    name: 'Instagram',
                    img: '/static/img/thumbs/instagram.png',
                    total: 23798,
                    percentage: 30,
                },
                {
                    id: 'facebook',
                    name: 'Facebook',
                    img: '/static/img/thumbs/facebook.png',
                    total: 11899,
                    percentage: 15,
                },
                {
    ...
    recentCampaign: [
        {
            ...
            name: 'فروش تابستانی',
            startDate: moment(currentDate).subtract(10, 'days').format('jYYYY/jMM/jDD'),
            endDate: moment(currentDate).add(3, 'days').format('jYYYY/jMM/jDD'),
            budget: 20000,
            leadsGenerated: 500,
            conversions: 50,
            conversionRate: 10,
        ...
        },
        {
            ...
            name: 'پروموی بازگشت به مدرسه',
            startDate: moment(currentDate).subtract(5, 'days').format('jYYYY/jMM/jDD'),
            endDate: moment(currentDate).add(4, 'days').format('jYYYY/jMM/jDD'),
            budget: 15000,
            leadsGenerated: 400,
            conversions: 35,
            conversionRate: 8.75,
        ...
        },
        {
            ...
            name: 'راه‌اندازی محصول جدید',
            startDate: moment(currentDate).subtract(2, 'days').format('jYYYY/jMM/jDD'),
            endDate: moment(currentDate).add(6, 'days').format('jYYYY/jMM/jDD'),
            budget: 30000,
            leadsGenerated: 600,
            conversions: 60,
            conversionRate: 10,
