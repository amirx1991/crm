...
const countryOptions: Option[] = [
    { value: 'us', label: 'United State', imgPath: '/static/img/countries/US.png' },
    { value: 'cn', label: 'China', imgPath: '/static/img/countries/CN.png' },
    { value: 'jp', label: 'Japan', imgPath: '/static/img/countries/JP.png' },
    { value: 'fr', label: 'French', imgPath: '/static/img/countries/FR.png' },
]
